...
public class DragonCrystalPouchScreen extends HandledScreen<DragonCrystalPouchScreenHandler> {
    ...
    public DragonCrystalPouchScreen(DragonCrystalPouchScreenHandler handler, PlayerInventory player, Text title) {
